...
public class UtFilterTest extends BaseTest {
    ...
    public void filterTest() {
        ...
        Assertions.assertEquals(expectedDayForward, actualDayForward); // проверка на основной ценник
        ...
        Assertions.assertTrue(isAllDaysForwardOk); // проверка на поисковую выдачу
